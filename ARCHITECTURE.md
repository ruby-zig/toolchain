...
executable lock contains eight lanes: GNU for `bigdecimal`, `io-console`,
`json`, `stringio`, `strscan`, and CRuby, plus GNU and musl for `prism`. Those
selected profiles make the current desired workload 323 lanes across active
shards of 252 and 71. io-console's executable contract loads the exact staged
